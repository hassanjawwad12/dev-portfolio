...
export const BentoGridItem = ({
  ...
  const leftLists = ["ReactJS", "NextJs", "Typescript","Javascript"];
  const rightLists = ["Golang", "Docker", "PostGreSQL"];
  ...
  const handleCopy = () => {
    const text = "hassanjawwad12@gmail.com";
        ...
        >
          ...
          {id === 3 && (
            <div className="flex gap-1 lg:gap-5 w-fit absolute -right-3 lg:-right-2">
              <div className="flex flex-col gap-3 md:gap-3 lg:gap-4 mt-4">
